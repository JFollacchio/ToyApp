...
class UsertestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usertest" do
    assert_difference('Usertest.count') do
      post usertests_url, params: { usertest: { email: @usertest.email, name: @usertest.name } }
    end
  ...
  test "should update usertest" do
    patch usertest_url(@usertest), params: { usertest: { email: @usertest.email, name: @usertest.name } }
